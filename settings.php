 ...
 * @endcode
 */
$settings['hash_salt'] = 'aJVrqMfjBCLUn73pgnfkpvePEfvtd3LyfAQp1hK0TgTlEj8tw5GRu5IdHVYu0ISkgMb5jsh_jw';
 ...
 */
$settings['file_private_path'] = '/opt/ipride_private_files';
...
$config_directories['sync'] = 'sites/default/files/config__xWrQUYZxljqLRHUn_WQOudPc1ZJKyAO9-l4U9qRT5w0fd3BgRgGH3YcYhhPJH_mLd4gF6TRWw/sync';


$s3_scheme_base = [
  'driver' => 's3',
  'config' => [
    'key'    => 'AKIAIG2A6VINAE3P5JZQ',
    'secret' => '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',
    ...
    // 'prefix' => 'files',  // Directory prefix for all uploaded/viewed files.

    'cname' => 's3-ap-northeast-1.amazonaws.com',   // A cname that resolves to your bucket. Used for URL generation.
  ],

//    'cache' => TRUE, // Creates a metadata cache to speed up lookups.
];

$s3_private_scheme = $s3_scheme_base;
$s3_private_scheme['config']['options']['ACL'] = 'private';
$s3_private_scheme['config']['prefix'] = 'private';

$s3_cabinet_scheme = $s3_private_scheme;
$s3_cabinet_scheme['config']['prefix'] = 'cabinet';

$s3_public_scheme = $s3_scheme_base;
$s3_public_scheme['config']['options']['ACL'] = 'public-read';
$s3_public_scheme['config']['prefix'] = 'public';

$schemes = [
  's3-private' => $s3_private_scheme,
  's3-cabinet' => $s3_cabinet_scheme,
  's3-public' => $s3_public_scheme,
];
